...
function OtherCard({ backdrop_path, title, id }) {
    ...
    return (
        <Link to={`/home/${id}`}>
            <div className=' w-[118px] sm:w-[220px] md:w-[240] lg:w-[268px] relative inline-block  duration-300 ease-in-out   shadow-md hover:shadow-red-50/40 cursor-pointer '>
